...
| An answer is the whole interaction's | **Implemented, tested** | every bounded turn's piece, in order, exactly once, concatenated exactly along parent links; a continuation resumes the message it continues where the session allows; Ego's conclusion is recorded once from the finished whole — see I107, I109, I112 |
